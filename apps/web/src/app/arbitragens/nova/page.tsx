        ...
        <div className="flex items-center gap-2 mb-8">
          {STEPS.map((s, i) => (
            <div key={s} className="flex items-center gap-2">
              ...
              <span className={`text-sm ${i <= step ? 'text-primary-700 font-medium' : 'text-gray-400'}`}>
                {s}
              </span>
          ...
          {step === 1 && (
            <div className="space-y-4">
              ...
              <div>
                ...
                />
                <p className="text-xs text-gray-400 mt-1">{form.objeto.length}/50 caracteres</p>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="rounded"
                />
                <label htmlFor="urgencia" className="text-sm text-gray-700">
