  ...
  return (
    <AuthLayout>
      <div className="p-8 max-w-3xl mx-auto">
        <h1 className="text-3xl font-bold text-primary-700 mb-8">Configuracoes</h1>

        {/* Perfil */}
        <div className="bg-white rounded-xl shadow p-6 mb-6">
          <h2 className="font-semibold text-gray-800 mb-4">Meu Perfil</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p className="font-medium text-gray-800">{user?.cpfCnpj}</p>
            </div>
            <div>
              <label className="block text-xs text-gray-400 mb-1">Telefone</label>
              <p className="font-medium text-gray-800">{user?.telefone}</p>
            </div>
            <div>
            ...
            {user?.oabNumero && (
              <div>
                <label className="block text-xs text-gray-400 mb-1">OAB</label>
                <p className="font-medium text-gray-800">{user.oabNumero}</p>
              </div>
            )}
            <div>
              <label className="block text-xs text-gray-400 mb-1">Conta criada em</label>
        ...
        <div className="bg-white rounded-xl shadow p-6 mb-6">
          <div className="flex justify-between items-center mb-4">
            <h2 className="font-semibold text-gray-800">Assinatura Digital</h2>
            <Link href="/certificado-digital" className="text-sm text-primary-600 hover:underline">
              Gerenciar &rarr;
            </Link>
          </div>
          ...
          {certStatus?.temCertificado ? (
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                <div>
                  <span className="text-gray-400">Titular (CN)</span>
            ...
            <div className="text-center py-4">
              <p className="text-gray-500 mb-3">Nenhum certificado digital configurado.</p>
              <Link
        ...
        {/* Plano */}
        <div className="bg-white rounded-xl shadow p-6 mb-6">
          <h2 className="font-semibold text-gray-800 mb-4">Meu Plano</h2>
        ...
        {/* Seguranca */}
        <div className="bg-white rounded-xl shadow p-6 mb-6">
          <h2 className="font-semibold text-gray-800 mb-4">Seguranca</h2>
          <div className="space-y-3">
        ...
        <div className="bg-white rounded-xl shadow p-6">
          <h2 className="font-semibold text-gray-800 mb-4">Informacoes Legais</h2>
